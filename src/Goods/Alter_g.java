 ...
 * @author 1U02UN
 */
public class Alter_g extends javax.swing.JFrame {

    public Alter_g() throws SQLException {
        initComponents();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addComponent(jTextField_stock, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jTextField_goods, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(37, 37, 37))
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jComboBox_supplier, 0, 169, Short.MAX_VALUE))
    ...
    private void jButton_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_addActionPerformed
        ...
        if(checkGoodsInput()){
           ...
           String sql = "update goods set goods='"+goods+"',kind='"+kind+"',price='"+price+"',supplier='"+supplier+"',descpp='"+descpp+"',stock='"+stock+"' where id="+id;
           DBHelper.update(sql);
           showMessageDialog(this, "商品信息修改成功！", "提示", javax.swing.JOptionPane.INFORMATION_MESSAGE);			                
           dispose();
           try {
                init_g.initGoodsTable();
                init_ComboBox.initjComboBox_goods();
                } catch (SQLException ex) {
                    Logger.getLogger(Alter_g.class.getName()).log(Level.SEVERE, null, ex);
                }        
        }              
   ...
   public boolean checkGoodsInput(){
    ...
    public void getGoodsInfo(){
        String goods=jTable_Goods.getValueAt(jTable_Goods.getSelectedRow(),1).toString();
        String kind=jTable_Goods.getValueAt(jTable_Goods.getSelectedRow(),3).toString();
        String price=jTable_Goods.getValueAt(jTable_Goods.getSelectedRow(),2).toString();
        String supplier=jTable_Goods.getValueAt(jTable_Goods.getSelectedRow(),4).toString();
        String stock=jTable_Goods.getValueAt(jTable_Goods.getSelectedRow(),5).toString();
        String descpp=jTable_Goods.getValueAt(jTable_Goods.getSelectedRow(),6).toString();
        jTextField_goods.setText(goods);
        jTextField_kind.setText(kind);
        jTextField_price.setText(price);
        jComboBox_supplier.setSelectedItem(supplier);
        jTextField_descpp.setText(descpp);
