 ...
 * @author 1U02UN
 */
public class Add_s extends javax.swing.JFrame {
    ...
    private void jButton_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_addActionPerformed
        ...
        if(checkSupplierInput()){
            ...
            String sql = "insert into supplier(name,phone,email,address) values('"+name+"','"+phone+"','"+mail+"','"+address+"'"+")";  
            DBHelper.update(sql);
            javax.swing.JOptionPane.showMessageDialog(this, "供应商添加成功！", "提示", javax.swing.JOptionPane.INFORMATION_MESSAGE);			                
            dispose();
            try {
                    init_s.initSupplierTable();
                    Goods.init_ComboBox.initjComboBox_sup();
